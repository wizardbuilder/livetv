...
def is_addon_dir( addon ):
    ...
    if not os.path.isdir( addon ) or addon == ".svn" or addon == ".git": return False
    else: return True
   ...
   def _recursive_zipper( self, dir, zip_file ):
            ...
            for root, dirs, files in os.walk(dir):
                    ...
                    for f in files:
                            ...
                            if ".git" in fullpath or ".svn" in fullpath: continue
                            else:
   ...
   def _create_compressed_addon_release( self ):
       ...
       for the_file in self.addon_folder_contents:
              ...
              if not os.path.isfile( the_path ):
                      shutil.rmtree( the_path , onerror=readonly_handler)
